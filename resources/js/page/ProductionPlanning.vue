<template>
    <div class="p-6">
        <div class="space-y-6">
            <h1 class="text-3xl font-bold">生産計画設定</h1>
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                    ...
                    <div>
                        <div class="relative">
                            <select v-model="selectedYear"
                                class="appearance-none border border-gray-300 rounded-lg px-[2rem] py-2 w-medium40 font-medium text-gray-700 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="month in months" :key="month" class="group hover:bg-gray-50 transition-colors">
                                <td
                                    class="px-6 py-3 whitespace-nowrap text-sm font-medium text-gray-700 group-hover:bg-gray-50">
                                    {{ month }}月</td>
                                <td class="px-6 py-3 whitespace-nowrap">
                                    <input type="number" v-model="currentPlan[month].units"
                                ...
                                <td class="px-6 py-3 whitespace-nowrap">
                                    <input type="text" v-model="currentPlan[month].notes"
                ...
                <div class="mt-6 flex justify-end">
                    <button @click="save"
                        class="bg-blue-600 text-white px-6 py-2.5 rounded-lg font-bold hover:bg-blue-700 shadow-sm transition-all active:scale-95 flex items-center gap-2">
